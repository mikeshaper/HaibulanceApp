...
public class GoogleMapsActivity extends AppCompatActivity implements OnMapReadyCallback, View.OnClickListener {

    private Button flora_butt;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        flora_butt = findViewById(R.id.flora_butt);
        report = findViewById(R.id.report_butt);

        flora_butt.setOnClickListener(this);
